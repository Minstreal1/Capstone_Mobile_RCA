...
MaterialTypeData materialTypeFromJson(String str) => MaterialTypeData.fromJson(json.decode(str));
...
class MaterialTypeData {
    ...
    factory MaterialTypeData.fromJson(Map<String, dynamic> json) => MaterialTypeData(
        id: json["id"],
        name: json["name"],
